...
import { tradePressProvider } from "@/lib/radar/providers/trade-press";
...
export const SIGNAL_PROVIDERS: SignalProvider[] = [newsProvider, regionalProvider, labourMarketProvider, tradePressProvider, trendsProvider];
