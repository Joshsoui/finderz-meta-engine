...
export default function LeadsPage() {
  ...
  return (
    <AppShell active="leads" title="Leads" subtitle="Sollicitaties uit alle campagnes, markeer bruikbare leads">
      <article className="panel overflow-hidden">
        <div className="panel-header">
          <div>
            <div className="eyebrow"><Users className="size-3.5" />Alle leads</div>
        ...
        {isLoading ? (
          ...
          <p className="py-16 text-center text-sm text-[#7f97a8]">Nog geen leads binnengekomen. Zodra Meta is gekoppeld en een campagne live staat, verschijnen sollicitaties hier automatisch.</p>
        ) : (
